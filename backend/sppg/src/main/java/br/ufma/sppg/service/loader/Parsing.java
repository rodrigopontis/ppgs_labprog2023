...
public class Parsing extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes atts) {
        ...
        if (qName.compareTo("CURRICULO-VITAE") == 0) {
            // pode dar problema
            // try {
            // ref.setDataAtualizacao(new
            // SimpleDateFormat("dd/MM/yyyy").parse(atts.getValue("DATA-ATUALIZACAO")));
        ...
        if (qName.compareTo("DETALHAMENTO-DO-TRABALHO") == 0) {
            ...
            lastEvento.setNomeLocal(
                    atts.getValue("NOME-DO-EVENTO") + " - " + atts.getValue("TITULO-DOS-ANAIS-OU-PROCEEDINGS"));
        }
        ...
        if (qName.compareTo("DETALHAMENTO-DO-SOFTWARE") == 0) {
            ...
            // lastTecnica.setOutras_informacoes("Plataforma: " +
            // atts.getValue("PLATAFORMA") + "; ");
        ...
        if (qName.compareTo("DETALHAMENTO-DE-CURSOS-CURTA-DURACAO-MINISTRADO") == 0) {
            if (lastTecnica == null)
                lastTecnica = new Tecnica();
            lastTecnica.setOutrasInformacoes(
                    "Participação dos autores: " + atts.getValue("PARTICIPACAO-DOS-AUTORES") + "; " +
