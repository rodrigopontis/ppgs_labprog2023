...
public interface DocenteRepository
        ...
        Docente findByLattes(String lattes);
        ...
        List<Producao> obterProducoes(@Param("idDocente") Integer idDocente, @Param("anoIni") Integer anoIni,
        ...
        List<Orientacao> obterOrientacoes(@Param("idDocente") Integer idDocente, @Param("anoIni") Integer anoIni,
                        @Param("anoFin") Integer anoFin);

        @Query("select t from Docente d join d.tecnicas t where (d.id = :idDocente and t.ano >= :anoIni and t.ano <= :anoFin)")
        List<Tecnica> obterTecnicas(@Param("idDocente") Integer idDocente, @Param("anoIni") Integer anoIni,
                        @Param("anoFin") Integer anoFin);
}
